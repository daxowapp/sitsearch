<div class="up-campus-card">
  ...
  <div class="up-campus-footer">
    <a href="https://www.google.com/maps?q=<?= esc_attr(urlencode($university['map'] ?? '')) ?>" target="_blank" rel="noopener noreferrer" class="up-campus-action">
    ...
    <a href="<?= esc_url($university['guid']) ?>" class="up-campus-btn">
      Programs <span>&rarr;</span>
    </a>
  </div>
</div>