<div class="sit-ai-search-container" style="max-width: 800px; margin: 0 auto; padding: 20px; font-family: sans-serif;">
    <form id="sit-ai-search-form" class="ai-search-box" style="position: relative;">
        ...
        <button type="submit" id="sit-ai-search-btn" style="position: absolute; right: 8px; top: 50%; transform: translateY(-50%); background: #E20A17; color: #fff; border: none; padding: 12px 24px; border-radius: 25px; font-size: 15px; font-weight: 600; cursor: pointer;">Search</button>
    </form>
